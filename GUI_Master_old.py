...
root.title("Brain_Stroke_MRI_image")
...
image2 = image2.resize((1105, 705), Image.ANTIALIAS)
...
lbl = tk.Label(root, text="Brain_Stroke_MRI_image", font=('times', 30,' bold '), width=60,height=1,bg="#008080",fg="white")
lbl.place(x=0, y=0)
...
wlcm=tk.Label(root,text="......Welcome Brain_Stroke_MRI_image System......",width=100,height=1,background="#FF6103",foreground="white",font=("Times new roman",19,"bold"))
wlcm.place(x=0,y=655)


frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=262, height=645, bd=5, font=('times', 14, ' bold '),bg="pink")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=2, y=52)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='Brain_Stroke_MRI_image', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
button3 = tk.Button(frame_alpr, text="Precautions", command=pre, width=15, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
